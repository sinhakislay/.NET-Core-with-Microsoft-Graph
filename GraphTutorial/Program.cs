    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (choice != 0) {
                ...
                Console.WriteLine("4. Show Email Messages");
                ...
                switch(choice)
                {
                    ...
                    case 4:
                        // Show email messages
                        ListEmailMessages(user.MailboxSettings.TimeZone);
                        break;
                    default:
            ...
            string dateTimeFormat)
        {
            ...
            if(dateTimeFormat != " ")
                ...
                return dateTime.ToString(DateTime.Now.ToString("MM/dd/yyyy"));
        }
        ...
        static void ListEmailMessages(string userTimeZone)
        {
            var messages = GraphHelper
                .GetEmailMessagesCurrentUser(DateTime.Today)
                .Result;

            Console.WriteLine("Messages:");

            foreach (var EmailMessages in messages)
            {
                Console.WriteLine($"Subject: {EmailMessages.Subject}");
                Console.WriteLine($"  Body Preview: {EmailMessages.BodyPreview}");
                Console.WriteLine($"  From: {EmailMessages.From.EmailAddress}");
                Console.WriteLine($"  End: {EmailMessages.SentDateTime}");
            }
        }
